 ...
 */
public class BhajanActivity extends ActionBarActivity implements android.app.ActionBar.TabListener, android.support.v7.app.ActionBar.TabListener {

    private DrawerLayout mDrawerLayout;
    private ViewPager viewPager;
    private BhajansTabsPagerAdapter mAdapter;
   ...
   // int[] iconList = new int[]{R.drawable.about, R.drawable.about,R.drawable.about,R.drawable.about};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BhajansTabsPagerAdapter(getSupportFragmentManager());
    ...
    private void selectItem(int position) {
        switch(position){
            case 0:
                Intent intentHome = new Intent(BhajanActivity.this, HomeActivity.class);
                startActivity(intentHome);
                finish();
                break;
            case 2:
                Intent intentAarathi = new Intent(BhajanActivity.this, AarathiActivity.class);
